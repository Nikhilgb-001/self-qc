...
#         if "Field" in headers and "Manual Value" in headers:
#             field_col_idx = headers.index("Field") + 1
#             manual_val_col_idx = headers.index("Manual Value") + 1
